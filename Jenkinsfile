pipeline {
    ...
    stages {
        ...
        stage("updating the service of cloud run"){
            steps{
                sh '''export GOOGLE_OAUTH_ACCESS_TOKEN=$(gcloud auth print-access-token --impersonate-service-account jenkins-gcloud@proyekdicoding-416705.iam.gserviceaccount.com) > cred.txt'''
